...
void FECB_CTRL(int MCMADDR )
{
  ...
  switch(exeCmd.CmdNum)
  {
       case 1 :  // NULL
                 ...
                 buff[8]=0;
                // InitBuff(buff);
                 // printf("$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$ NULL COMMAND in FECB_CNTRL ##########################\n");
                 // printf("$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$ MCM Address in FECB_CNTRL %d\n ##########################\n",MCMADDR);
                  write_read(buff,buf_ptr0,rbuff);  
                 break;
       case 2 : // IDL Mode
  ...
  /*   for (i=0; i<12; i++)
        printf("NULL PKT in FECB_MCM ====>0x%02X\n", buff[i]); */
 // write_read(buff,buf_ptr0,rbuff);  
 /*  int k;
   for(k = 0; k <rbuff.Length ; k++) 
     {
		                              
       printf("$$$$$$$$$ LOW LEVEL MCM =====> MCM RESPONSE BUFFER [%d] = 0x%02X\n", k,rbuff.Msg[k] );
